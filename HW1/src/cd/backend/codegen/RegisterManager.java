...
public class RegisterManager {
    ...
    public enum Register {
        EAX("%eax", ByteRegister.EAX), EBX("%ebx", ByteRegister.EBX), ECX("%ecx", ByteRegister.ECX), EDX("%edx", ByteRegister.EDX),
        ESI("%esi", null), EDI("%edi", null), EBP("%ebp", null), ESP("%esp", null);
